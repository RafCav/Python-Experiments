...
ANS1 = (790, 515) if screen_size == '1600x900' else (940, 615)
ANS1_BLOCK = (790, 525) if screen_size == '1600x900' else (940, 630)
ANS2 = (790, 548) if screen_size == '1600x900' else (940, 660)
ANS2_BLOCK = (790, 558) if screen_size == '1600x900' else (940, 675)
ANS3 = (790, 580) if screen_size == '1600x900' else (940, 705)
ANS3_BLOCK = (790, 590) if screen_size == '1600x900' else (940, 720)
